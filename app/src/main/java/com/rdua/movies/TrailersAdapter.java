...
public abstract class TrailersAdapter extends RecyclerView.Adapter<TrailersAdapter.TrailersViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull TrailersViewHolder holder, int position, @NonNull List<Object> payloads) {
